      ...
      >
        ...
        >
          ...
          <View className="flex-1 justify-center">
            <Text className="text-white font-pbold text-6xl mb-2">
              Create {'\n'}
              Account <Text className="text-blue-400">now</Text>
            </Text>
            ...
            <TextInput
              ...
              secureTextEntry
              className="w-full px-3 py-6 text-xl rounded-lg bg-[#282828] mb-10 text-white font-p"
            />
            ...
            >
              {isLoading ? (
                ...
                <Text className="text-white text-center py-1 text-xl font-pbold">
                  Sign Up
                </Text>
              )}
            </TouchableOpacity>
